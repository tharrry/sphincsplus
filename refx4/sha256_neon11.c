...
//static uint32x4_t load_bigendian_32(const uint8_t *x, size_t inlen) {
//    // Tested, works
//    uint32x4_t result;
//    for(int i = 0; i < 4; i++){
//        result[i] = 
//          (uint32_t)(x[3 + inlen*i]) | 
//        (((uint32_t)(x[2 + inlen*i])) << 8) |
//        (((uint32_t)(x[1 + inlen*i])) << 16) |
//        (((uint32_t)(x[0 + inlen*i])) << 24);
//    }
//    return result;
//}
...
//#define M_32(w0, w14, w9, w1) w0 = vaddq_u32((w9), vaddq_u32((sigma0_32(w1)), (w0)))
#define M_32(w0, w14, w9, w1) w0 = vaddq_u32(vaddq_u32((sigma1_32(w14)), (w9)), vaddq_u32((sigma0_32(w1)), (w0)));
...
static size_t crypto_hashblocks_sha256(uint8_t *statebytes,
    ...
    const uint8_t *ins[] = {in0,in1,in2,in3};
    ...
    while (inlen - offset >= 64) {
        ...
        //i = vld1q_u32(in32_0 +  0 + (offset / 4));
        //j = vld1q_u32(in32_1 +  0 + (offset / 4));
        //k = vld1q_u32(in32_2 +  0 + (offset / 4));
        //l = vld1q_u32(in32_3 +  0 + (offset / 4));
//
        //t = vtrn1q_u32(i, j);
        //j = vtrn2q_u32(i, j);
        //i = t;
...
//
//
        //i = vld1q_u32(in32_0 +  4 + (offset / 4));
        //j = vld1q_u32(in32_1 +  4 + (offset / 4));
        //k = vld1q_u32(in32_2 +  4 + (offset / 4));
        //l = vld1q_u32(in32_3 +  4 + (offset / 4));
//
        //t = vtrn1q_u32(i, j);
        //j = vtrn2q_u32(i, j);
        //i = t;
...
//
//
        //i = vld1q_u32(in32_0 +  8 + (offset / 4));
        //j = vld1q_u32(in32_1 +  8 + (offset / 4));
        //k = vld1q_u32(in32_2 +  8 + (offset / 4));
        //l = vld1q_u32(in32_3 +  8 + (offset / 4));
//
        //t = vtrn1q_u32(i, j);
        //j = vtrn2q_u32(i, j);
        //i = t;
...
//
//
        //i = vld1q_u32(in32_0 + 12 + (offset / 4));
        //j = vld1q_u32(in32_1 + 12 + (offset / 4));
        //k = vld1q_u32(in32_2 + 12 + (offset / 4));
        //l = vld1q_u32(in32_3 + 12 + (offset / 4));
//
        //t = vtrn1q_u32(i, j);
        //j = vtrn2q_u32(i, j);
        //i = t;
...
//
        ...
        for(int i = 0; i < 4; i++){
            w0[i] = 
              (uint32_t)(ins[i][3 + offset]) | 
            (((uint32_t)(ins[i][2 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + offset])) << 24);
            w1[i] = 
              (uint32_t)(ins[i][3 + 4 + offset]) | 
            (((uint32_t)(ins[i][2 + 4 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 4 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 4 + offset])) << 24);
            w2[i] = 
              (uint32_t)(ins[i][3 + 8 + offset]) | 
            (((uint32_t)(ins[i][2 + 8 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 8 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 8 + offset])) << 24);
            w3[i] = 
              (uint32_t)(ins[i][3 + 12 + offset]) | 
            (((uint32_t)(ins[i][2 + 12 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 12 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 12 + offset])) << 24);
            w4[i] = 
              (uint32_t)(ins[i][3 + 16 + offset]) | 
            (((uint32_t)(ins[i][2 + 16 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 16 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 16 + offset])) << 24);
            w5[i] = 
              (uint32_t)(ins[i][3 + 20 + offset]) | 
            (((uint32_t)(ins[i][2 + 20 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 20 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 20 + offset])) << 24);
            w6[i] = 
              (uint32_t)(ins[i][3 + 24 + offset]) | 
            (((uint32_t)(ins[i][2 + 24 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 24 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 24 + offset])) << 24);
            w7[i] = 
              (uint32_t)(ins[i][3 + 28 + offset]) | 
            (((uint32_t)(ins[i][2 + 28 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 28 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 28 + offset])) << 24);
            w8[i] = 
              (uint32_t)(ins[i][3 + 32 + offset]) | 
            (((uint32_t)(ins[i][2 + 32 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 32 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 32 + offset])) << 24);
            w9[i] = 
              (uint32_t)(ins[i][3 + 36 + offset]) | 
            (((uint32_t)(ins[i][2 + 36 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 36 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 36 + offset])) << 24);
            w10[i] = 
              (uint32_t)(ins[i][3 + 40 + offset]) | 
            (((uint32_t)(ins[i][2 + 40 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 40 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 40 + offset])) << 24);
            w11[i] = 
              (uint32_t)(ins[i][3 + 44 + offset]) | 
            (((uint32_t)(ins[i][2 + 44 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 44 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 44 + offset])) << 24);
            w12[i] = 
              (uint32_t)(ins[i][3 + 48 + offset]) | 
            (((uint32_t)(ins[i][2 + 48 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 48 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 48 + offset])) << 24);
            w13[i] = 
              (uint32_t)(ins[i][3 + 52 + offset]) | 
            (((uint32_t)(ins[i][2 + 52 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 52 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 52 + offset])) << 24);
            w14[i] = 
              (uint32_t)(ins[i][3 + 56 + offset]) | 
            (((uint32_t)(ins[i][2 + 56 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 56 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 56 + offset])) << 24);
            w15[i] = 
              (uint32_t)(ins[i][3 + 60 + offset]) | 
            (((uint32_t)(ins[i][2 + 60 + offset])) << 8) |
            (((uint32_t)(ins[i][1 + 60 + offset])) << 16) |
            (((uint32_t)(ins[i][0 + 60 + offset])) << 24);
        }
...
void sha256x4_inc_init(sha256ctx2 *state) {
    ...
    state->ctx = malloc(PQC_sha256ctx2_BYTES*4 + 8);
    if (state->ctx == NULL) {
        exit(111);
    }
...
void sha256x4_inc_ctx_clone(sha256ctx2 *stateout, const sha256ctx2 *statein) {
    stateout->ctx = malloc(PQC_sha256ctx2_BYTES*4);
    if (stateout->ctx == NULL) {
        exit(111);
    }
    memcpy(stateout->ctx, statein->ctx, PQC_sha256ctx2_BYTES*4);
}
...
void sha256x42(
    ...
    sha256x4_inc_ctx_release(&state);
}